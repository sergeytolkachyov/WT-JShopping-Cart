...
<a id="jshop_module_cart<?php echo $module->id;?>"  role="button" class="btn position-relative wt_jshop_module_cart wt-jshopping-cart-module-icon <?php echo $moduleclass_sfx;?>" href="<?php echo \JSHelper::SEFLink('index.php?option=com_jshopping&view=cart', 1);?>" rel="nofollow" title="<?php print Text::_('MOD_WTJSHOPPINGCART_GO_TO_CART');?>">
